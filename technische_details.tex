...
Eine Anleitung zur Verwendung dieser Features ist in der Vue Dokumentation nachzulesen\footnote{\url{https://vuejs.org/guide/essentials/component-basics.html}}.
\cite{vueComponents}
