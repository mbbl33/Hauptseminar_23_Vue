...
Eine Anleitung zur verwendung dieser ist in der Vue Dokumentation nachzulesen\footnote{https://vuejs.org/guide/essentials/component-basics.html}.
\cite{vueComponents}
...
\\
Die einfachste Form der Datenbindung in Vue ist die auch aus anderen Frameworks bekannte Mustache-Syntax möglich.
...
Die Mustache-Syntax ist unidirektionale vom Modell zur View.
...
\end{lstlisting}
%TODO https://vuejs.org/guide/essentials/template-syntax.html
%TODO Reactive, v-modell und v-bind
