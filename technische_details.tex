...
und bei änderungen im Model wird der Text im Inputfeld geupdatet. \cite{vueComponentV-model}
...
Um diesen \emph{router-view}-Tag herum können dann Elemente die immer zu sehen sein sollen angelegt werden,
wie z.B. eine Navigationsleiste. \cite{vueRouterGettingStarted}
...
Diese Features sind ausführlich in der Dokumentation des Vue-Routers beschrieben.

\section{State Management mit Vuex}
%TODO anderer Name
\section{Architektur}
