...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=.15\textwidth]{img/you}
...
Neues Feature ist unter anderem die Composition API, dazu mehr im Abschnitt \ref{}. \cite{konstantinidis2020} %TODO set ref
